...
from .models import User, Product, CartItem, Order, Review  # type: ignore
...
def seed_products(request):
    ...
    now = timezone.now()
    SEED = [
        {"name": "Hot Toys Iron Man Mark LXXXV", "description": "1/6th scale collectible figure from Avengers: Endgame. Die-cast construction with over 50 points of articulation and LED light-up features.", "price": 18500, "original_price": 22000, "images": ["/products/iron-man.jpg"], "category": "action-figures", "brand": "Hot Toys", "series": "Marvel Avengers", "condition": "mint-in-box", "stock": 5, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["marvel", "iron-man", "die-cast", "premium", "LED"], "is_featured": True, "is_flash_sale": False},
        {"name": "S.H.Figuarts Spider-Man No Way Home", "description": "Highly articulated action figure with multiple interchangeable hands and web effects. Includes Tom Holland head sculpt.", "price": 4200, "original_price": 5500, "images": ["/products/spider-man.jpg"], "category": "action-figures", "brand": "SHFiguarts", "series": "Marvel Spider-Man", "condition": "new", "stock": 12, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["marvel", "spider-man", "shf", "bandai"], "is_featured": True, "is_flash_sale": True, "flash_sale_end": now + timedelta(days=7)},
        {"name": "MAFEX Batman Hush", "description": "Premium 6-inch action figure based on the iconic Batman: Hush comic. Includes batarang, grapple gun, and fabric cape.", "price": 5800, "images": ["/products/batman.jpg"], "category": "action-figures", "brand": "Mafex", "series": "DC Comics", "condition": "new", "stock": 8, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["dc", "batman", "mafex", "medicom"], "is_featured": True, "is_flash_sale": False},
        {"name": "Dragon Ball Z Goku Ultra Instinct Statue", "description": "12-inch premium resin statue featuring Goku in Ultra Instinct form. Hand-painted with LED base effects.", "price": 12800, "original_price": 15000, "images": ["/products/goku.jpg"], "category": "statues", "brand": "Banpresto", "series": "Dragon Ball Z", "condition": "mint-in-box", "stock": 3, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["anime", "dragon-ball", "goku", "statue", "LED"], "is_featured": True, "is_flash_sale": True, "flash_sale_end": now + timedelta(days=5)},
        {"name": "LEGO Star Wars UCS Millennium Falcon", "description": "Ultimate Collector Series set with 7,541 pieces. Includes Han Solo, Chewbacca, Princess Leia, and C-3PO minifigures.", "price": 42000, "images": ["/products/millennium-falcon.jpg"], "category": "model-kits", "brand": "LEGO", "series": "Star Wars", "condition": "new", "stock": 2, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["lego", "star-wars", "ucs", "premium"], "is_featured": True, "is_flash_sale": False},
        {"name": "Gundam RG Wing Zero Custom EW", "description": "Real Grade 1/144 scale model kit. Features advanced inner frame and beautiful angel wing effect parts.", "price": 2200, "original_price": 2800, "images": ["/products/gundam-wing.jpg"], "category": "model-kits", "brand": "Bandai", "series": "Gundam Wing", "condition": "new", "stock": 20, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["gundam", "bandai", "model-kit", "real-grade"], "is_featured": False, "is_flash_sale": True, "flash_sale_end": now + timedelta(days=3)},
        {"name": "Jada Toys Batmobile 1989 1:24", "description": "Die-cast metal Batmobile from Tim Burton's 1989 Batman. Includes Batman figure. Opening cockpit and rubber tires.", "price": 1800, "images": ["/products/batmobile.jpg"], "category": "diecast", "brand": "Jada Toys", "series": "DC Comics", "condition": "new", "stock": 15, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["dc", "batman", "diecast", "batmobile"], "is_featured": False, "is_flash_sale": False},
        {"name": "One Piece Monkey D. Luffy Gear 5 Figure", "description": "Premium Ichiban Kuji prize figure of Luffy in Gear 5 Nika form. 10-inch tall with dynamic pose and cloud effects.", "price": 3500, "original_price": 4500, "images": ["/products/luffy.jpg"], "category": "action-figures", "brand": "Banpresto", "series": "One Piece", "condition": "new", "stock": 7, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["anime", "one-piece", "luffy", "gear-5"], "is_featured": True, "is_flash_sale": True, "flash_sale_end": now + timedelta(days=4)},
        {"name": "Naruto Shippuden Itachi Uchiha Statue", "description": "Premium resin statue of Itachi Uchiha with Susanoo aura effect. 14-inch tall, limited edition with certificate.", "price": 16500, "images": ["/products/itachi.jpg"], "category": "statues", "brand": "Tsume Art", "series": "Naruto Shippuden", "condition": "mint-in-box", "stock": 2, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["anime", "naruto", "itachi", "limited-edition"], "is_featured": True, "is_flash_sale": False},
        {"name": "McFarlane DC Multiverse The Flash", "description": "7-inch action figure with 22 points of articulation. Includes Speed Force lightning effects and display base.", "price": 1500, "original_price": 1900, "images": ["/products/flash.jpg"], "category": "action-figures", "brand": "McFarlane", "series": "DC Comics", "condition": "new", "stock": 25, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["dc", "flash", "mcfarlane", "budget-friendly"], "is_featured": False, "is_flash_sale": True, "flash_sale_end": now + timedelta(days=6)},
        {"name": "Demon Slayer Tanjiro & Nezuko Set", "description": "Twin-pack collectible figures of Tanjiro Kamado and Nezuko. Premium paint finish with water breathing effect parts.", "price": 4800, "images": ["/products/demon-slayer.jpg"], "category": "action-figures", "brand": "Banpresto", "series": "Demon Slayer", "condition": "new", "stock": 10, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["anime", "demon-slayer", "tanjiro", "nezuko"], "is_featured": False, "is_flash_sale": False},
        {"name": "Transformers Masterpiece Optimus Prime", "description": "Masterpiece MP-44 version 3.0. Die-cast parts, trailer included, fully transforms between robot and truck mode.", "price": 28000, "images": ["/products/optimus.jpg"], "category": "action-figures", "brand": "Takara Tomy", "series": "Transformers", "condition": "mint-in-box", "stock": 3, "sold": 0, "rating": 0, "rating_count": 0, "tags": ["transformers", "masterpiece", "optimus", "die-cast"], "is_featured": True, "is_flash_sale": False},
    ]
...
def add_review(request):
    ...
    try:
        ...
        return Response({'error': 'Product or User not found.'}, status=status.HTTP_404_NOT_FOUND)
    ...
    if not bought:
        return Response({'error': 'You must purchase the product and it must be delivered before reviewing it.'}, status=status.HTTP_403_FORBIDDEN)
    ...
    product.rating = round(sum(r.rating for r in reviews) / product.rating_count, 1)
    product.save()
